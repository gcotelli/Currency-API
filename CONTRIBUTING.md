...
You can report issues [here](https://github.com/gcotelli/Currency-API/issues/new)

## Contributing Code

- This project is AGPL v3 licensed, so any code contribution MUST be under the
  same license.
